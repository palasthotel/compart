...
class REST extends _Component {
	...
	public function rest_api_init() {
		register_rest_route( self::NAMESPACE, '/proposals', array(
		...
		register_rest_route( self::NAMESPACE, '/proposals/(?P<id>\d+)', array(
	...
	public function updateProposal( WP_REST_Request $request ) {
		...
		return [
			"success" => $this->plugin->database->updateProposalStatus( $proposalId, $status ),
		];
	}
